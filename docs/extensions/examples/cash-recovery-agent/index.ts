...
// Production wiring: same order as task-stack — arm channel, register
// dispatcher, start stdin loop. Gated on import.meta.main so test files
// can import this module without stealing stdin.
if (import.meta.main) {
  const ch = getChannel();
