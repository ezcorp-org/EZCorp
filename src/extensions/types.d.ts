...
export interface McpServerStdio {
    ...
    /**
     * Phase 55 / MCP-03: pre-opened raw FD for the compiled seccomp BPF
     * blob. Passed to Bun.spawn via the stdio array (index 3) so bwrap
     * can read it via `--seccomp 3`. Null when unavailable.
     */
